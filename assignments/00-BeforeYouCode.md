...
* We will also have [VSCodium](https://vscodium.com/) installed in the labs. Note: VSCodium is identical to VS Code with the single biggest difference: VSCodium doesn't track your usage data. You can [learn more about it here](https://itsfoss.com/vscodium/)
  ...
  * You can [download vscodium from here](https://github.com/VSCodium/vscodium/releases) 
    * Choosing the correct download item. Note that the exact version number (1.x.y.z) is 1.8ish right now but will change over time. The format around the version should be the same.
